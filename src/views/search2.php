            ...
            <div class='row results-header'>
                <div class='col-12'>
                    ...
                    <span style='float: right;'>
                        <form action=''>
                            <select name='sort' onchange="redirect(this.value)">
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	// if ($check) { // OK!
		...
		$query2 = "SELECT product_id, product_img_url, name, review_stars, review_num, price_dollars, price_cents, is_prime, product_condition, tag_1, tag_2 FROM products WHERE name = '$searchQ' OR tag_1 = '$searchQ' OR tag_2 = '$searchQ' ORDER BY review_stars DESC;";
