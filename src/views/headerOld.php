...
<html lang="en" dir="ltr">
    ...
    <body>
      ...
      <div id='topHalf'>
        ...
        <img id='logo' alt="AmazonLogo" src="images/amaz.png" />
        </div>
      ...
      <div id='bottomHalf'>
        ...
        <div class="dropdown">
            <button class="dropbtn">Today's Deals</button>
            <div class="dropdown-content"></div>
        </div>
        <div class="dropdown">
            <button class="dropbtn">Dewan's Amazon.com</button>
            <div class="dropdown-content"></div>
        </div>
        <div class="dropdown">
            <button class="dropbtn">Buy Again</button>
            <div class="dropdown-content"></div>
        </div>
        ...
        <div id='accountStuff'>
            ...
            <div class="dropdown">
                <button class="dropbtn">Prime</button>
                <div class="dropdown-content">
                  <a href="#">Link 1</a>
                  <a href="#">Link 2</a>
                  <a href="#">Link 3</a>
